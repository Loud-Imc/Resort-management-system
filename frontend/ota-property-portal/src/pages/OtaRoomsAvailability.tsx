    ...
    <div className="space-y-6 flex-1 flex flex-col">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="p-6 bg-card border border-border rounded-2xl shadow-sm flex flex-col max-h-[300px] overflow-hidden">
              ...
              {rooms.length === 0 ? (
                ...
                rooms.map((r) => (
                  <div key={r.id} className="py-2.5 flex justify-between items-center text-xs">
                    <span className="font-bold text-foreground">{r.roomNumber}</span>
