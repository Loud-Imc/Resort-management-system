...
export default function DeleteAccount() {
    ...
    if (success) {
        return (
            <div className="min-h-screen bg-[#fcfcfc] flex items-center justify-center pt-20">
                <div className="max-w-[1500px] mx-auto px-4 md:px-6 lg:px-12 w-full flex justify-center">
                    <div className="max-w-md w-full bg-white rounded-lg shadow-[0_20px_50px_rgba(0,0,0,0.03)] border border-gray-100 p-12 text-center">
                        ...
                        <button
                            onClick={() => navigate('/')}
                            className="w-full py-4 bg-primary-900 text-white font-bold rounded-lg hover:bg-black transition-all shadow-xl shadow-primary-100 uppercase tracking-widest text-xs"
                        >
                            Return Home
                        </button>
                    </div>
        ...
        <div className="min-h-screen bg-[#fcfcfc] pt-32 pb-20">
            <div className="max-w-[1500px] mx-auto px-4 md:px-6 lg:px-12">
                <div className="max-w-2xl mx-auto">
                    <div className="bg-white rounded-lg shadow-[0_20px_50px_rgba(0,0,0,0.03)] border border-gray-100 overflow-hidden">
                        <div className="p-10 md:p-14">
                            ...
                            <div className="space-y-6 mb-12 bg-red-50/50 rounded-lg p-8 border border-red-100/50">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                    <button
                                        ...
                                        className="flex-1 py-4 bg-gray-50 text-gray-600 font-bold rounded-lg hover:bg-gray-100 transition-all uppercase tracking-widest text-xs"
                                    >
                                        Cancel & Go Back
                                    </button>
                                    <button
                                        ...
                                        className="flex-[2] py-4 bg-red-600 text-white font-bold rounded-lg hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-xl shadow-red-100 uppercase tracking-widest text-xs flex items-center justify-center gap-3"
                                    >
