        ...
        <div className="hidden md:block w-full">
            ...
            >
                <div className={`flex divide-x ${isDark ? 'divide-white/10' : 'divide-gray-100'}`}>
                    {/* Location Segment */}
                    <div className={`flex-1 p-10 hover:${isDark ? 'bg-white/5' : 'bg-gray-50'} first:hover:rounded-l-[3rem] transition-all duration-300 cursor-pointer group`}>
                        <label className={`block text-[11px] font-black uppercase tracking-[0.3em] ${isDark ? 'text-white/50' : 'text-gray-400'} mb-4`}>Location</label>
                        <div className="flex items-center gap-5">
                            ...
                            <div className="flex-1">
                                ...
                                />
                                <p className={`text-[11px] ${isDark ? 'text-white/30' : 'text-gray-400'} mt-2 font-medium italic tracking-wide`}>Destination, city or resort</p>
                            </div>
                        </div>
                    </div>
