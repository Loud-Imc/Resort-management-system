    ...
    <div className="max-w-4xl mx-auto py-6">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground">Stay updated with your property activities</p>
        </div>
        <button
      ...
      <div className="space-y-4">
        {notifications?.length === 0 ? (
          <div className="text-center py-20 bg-card rounded-xl border-2 border-dashed border-border text-muted-foreground">
          ...
          notifications?.map((notification) => (
            <div
              ...
              className={clsx(
                ...
                notification.isRead ? "border-border opacity-75" : "border-primary/30 shadow-sm ring-1 ring-primary/5"
              )}
            >
              <div className="flex gap-4">
                <div className={clsx(
                  ...
                  {notification.type === 'BOOKING_CREATED' ? <Bell className="h-5 w-5" /> : <Info className="h-5 w-5" />}
                </div>
