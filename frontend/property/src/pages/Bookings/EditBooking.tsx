...
export default function EditBooking() {
    ...
    return (
        <div className="max-w-4xl mx-auto pb-10">
            ...
            <div className="mb-6 p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-2xl flex items-start gap-3 text-amber-700 dark:text-amber-300">
