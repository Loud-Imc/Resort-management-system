...
export class ReportsService {
    ...
    async generatePdfReport(user: any, startDate: Date, endDate: Date, propertyId?: string, section?: string, search?: string): Promise<Buffer> {
        ...
        try {
            ...
            contentBlocks.push({
                text: 'Disclaimer: This report is generated automatically by Oreedu Analytics. Data might have slight variations based on real-time processing.',
    ...
    async getGstReport(user: any, startDate: Date, endDate: Date, propertyId?: string) {
        ...
        const reportData = bookings.map(b => {
            ...
            return {
                ...
                guestName: b.user ? `${b.user.firstName || ''} ${b.user.lastName || ''}`.trim() : ((b as any).guestName || 'Guest'),
        ...
        const creditNoteData = creditNotes.map(cn => ({
            ...
            guestName: cn.booking?.user ? `${cn.booking.user.firstName || ''} ${cn.booking.user.lastName || ''}`.trim() : ((cn.booking as any)?.guestName || 'Guest'),
